        ...
        {[
          ...
          <Box key={f.id} flexDirection="column" marginBottom={1}>
            ...
            <Box flexDirection="row" gap={2}>
              <Box borderStyle="round" borderColor={field === f.id ? f.color : 'gray'} paddingX={1} flexGrow={1}>
                <TextInput
                  value={f.value}
                  onChange={f.setter}
                  onSubmit={() => {
              ...
              {/* {(f.id === 'frontImage' || f.id === 'backImage') && f.value && (
                <Box borderStyle="single" borderColor="gray" paddingX={1}>
                  <Image filename={f.value} maxHeight={5} />
                </Box>
              )} */}
            </Box>
          </Box>
